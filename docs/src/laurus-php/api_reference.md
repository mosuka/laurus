...
| `array` of ISO 8601 strings (sequential) | `DateTimeArray` | Each element parsed as RFC 3339; a non-datetime string is an error. Requires `$multiValued = true` on the field |
